...
<?php $__env->startSection('title', 'Contacto — The Royale Palace'); ?>
        ...
        <div class="container">
            <div class="contacto-grid">
                ...
                <div class="contacto-card fade-in-up" style="animation-delay: 0.2s;">
                    ...
                    <a href="<?php echo e(route('sucursales')); ?>" class="contacto-card-link">
                        Ver Sedes
                        <i class="bi bi-arrow-right"></i>
                    </a>
                </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\royale-palace\resources\views/contacto.blade.php ENDPATH**/ ?>
...
<?php $__env->startSection('title', 'Menú — The Royale Palace'); ?>
        ...
        <div class="container">
            <div class="sedes-cards-grid">
                ...
                <?php $__currentLoopData = $sedes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $sede): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <a href="<?php echo e(route('menu.sede', $sede->slug)); ?>" class="sede-menu-card fade-in-up">
                        <div class="sede-menu-card-icon">
                            <i class="bi <?php echo e($sedeIcons[$sede->slug] ?? 'bi-geo-alt'); ?>"
                        ...
                        <div class="sede-menu-card-content">
                            <p class="sede-menu-card-zona">
                                ...
                                Zona <?php echo e($sede->zona); ?>

                            </p>
                            <h2 class="sede-menu-card-nombre"><?php echo e($sede->nombre); ?></h2>
                            <div class="sede-menu-card-divider"></div>
                            <p class="sede-menu-card-desc">
                                <?php echo e($sedeDescripciones[$sede->slug] ?? 'Descubre nuestros platillos exclusivos.'); ?>
        ...
        <div class="container" style="position: relative; z-index: 1;">
            <div class="fade-in-up">
                ...
                <div class="d-flex gap-3 justify-content-center flex-wrap">
                    ...
                    <a href="<?php echo e(route('contacto')); ?>" style="display: inline-flex; align-items: center; gap: 8px; padding: 14px 36px; 
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\royale-palace\resources\views/menu/index.blade.php ENDPATH**/ ?>
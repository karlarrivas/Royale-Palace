...
<?php $__env->startSection('title', 'The Royale Palace — Sabores Auténticos de El Salvador'); ?>
...
<section class="trp-hero">
    <div class="hero-video-wrapper">
        <video class="hero-video" autoplay loop muted playsinline poster="<?php echo e(asset('images/hero-bg.jpg')); ?>">
            <source src="<?php echo e(asset('videos/restaurant-ambient.mp4')); ?>" type="video/mp4">
            
            <img src="<?php echo e(asset('images/hero-bg.jpg')); ?>" alt="The Royale Palace">
        </video>
    ...
    <div class="hero-content">
        ...
        <div class="hero-ctas">
            <a href="<?php echo e(route('reservaciones.create')); ?>" class="hero-btn hero-btn-primary">
                <i class="bi bi-calendar-check"></i>Reservar Mesa
            </a>
            <a href="<?php echo e(route('menu.index')); ?>" class="hero-btn hero-btn-secondary">
    ...
    <div class="container">
        <div class="row align-items-center g-5">
            ...
            <div class="col-lg-5 fade-in-up">
                ...
                <a href="<?php echo e(route('nosotros')); ?>" class="btn-outline-gold mt-4">
...
<section class="platos-section">
    <div class="container">
        ...
        <div class="row g-4">
                ...
                <div class="plato-card" style="border-color:var(--color-gold);">
                    ...
                    <div class="plato-card-body">
                        ...
                        <div class="plato-card-footer">
                            ...
                            <a href="<?php echo e(route('menu.sede', 'san-salvador')); ?>" class="btn-gold"
            ...
            <div class="col-12 col-lg-7">
                <div class="row g-4 h-100">
                    ...
                    <?php $__currentLoopData = $destacados; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $i => $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="col-6 fade-in-up" style="transition-delay:<?php echo e($i * 0.1); ?>s">
                            <div class="plato-card">
                                <div class="plato-card-img-box" style="height:120px;background:var(--color-bg-soft);">
                                    <div class="no-img">
                                        <i class="bi <?php echo e($item['icon']); ?>" style="font-size:2rem;color:var(--color-line);"></i>
                                    </div>
                                </div>
                                <div class="plato-card-body">
                                    <p class="plato-card-categoria"><?php echo e($item['zona']); ?></p>
                                    <h3 class="plato-card-nombre"><?php echo e($item['nombre']); ?></h3>
                                    <p class="plato-card-desc" style="font-size:0.73rem;"><?php echo e($item['desc']); ?></p>
                                    <div class="plato-card-footer">
                                        <span class="plato-precio">$<?php echo e($item['precio']); ?></span>
                                        <a href="<?php echo e(route('menu.sede', $item['sede'])); ?>"
        ...
        <div class="text-center mt-5 fade-in-up">
            <a href="<?php echo e(route('menu.index')); ?>" class="btn-outline-gold">
    ...
    <div class="container-fluid px-0">
        <div class="row g-0">
            ...
            <?php $__currentLoopData = $sedes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $sede): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <?php $info = $sedesInfo[$sede->slug] ?? ['bg' => '', 'zona' => $sede->zona ?? '']; ?>
                <br>
                <div class="col-12 col-md-4">
                    <a href="<?php echo e(route('menu.sede', $sede->slug)); ?>" class="sede-card fade-in-up">
                        <div class="sede-card-bg" style="background-image:url('<?php echo e($info['bg']); ?>');"></div>
                        <div class="sede-card-overlay"></div>
                        <div class="sede-card-content">
                            <p class="sede-zona">
                                <i class="bi bi-geo-alt-fill"></i><?php echo e($info['zona']); ?>

                            </p>
                            <h3 class="sede-nombre"><?php echo e($sede->nombre); ?></h3>
                            <p class="sede-dir">
                                <i class="bi bi-map"></i><?php echo e($sede->direccion); ?>
                ...
                <div class="reserva-form-wrap">
                    ...
                    <?php if(auth()->guard()->guest()): ?>
                        <div style="text-align:center;padding:2rem 0;">
                            ...
                            <a href="<?php echo e(route('login')); ?>" class="btn-gold">
                                <i class="bi bi-box-arrow-in-right"></i> Iniciar Sesión
                            </a>
                        </div>
                    <?php else: ?>
                        <form action="<?php echo e(route('reservaciones.store')); ?>" method="POST">
                            <?php echo csrf_field(); ?>
                            <div class="row g-3">
                                <div class="col-md-6">
    ...
    <div class="container" style="position:relative;z-index:1;">
        <div class="fade-in-up">
            ...
            <div class="d-flex gap-3 justify-content-center flex-wrap">
                <a href="<?php echo e(route('reservaciones.create')); ?>" class="btn-gold">
                    <i class="bi bi-calendar-check"></i> Reservar Ahora
                </a>
                <a href="<?php echo e(route('sucursales')); ?>"
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\royale-palace\resources\views/home.blade.php ENDPATH**/ ?>
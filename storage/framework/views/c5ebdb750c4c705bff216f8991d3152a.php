...
<head>
    ...
    <title><?php echo $__env->yieldContent('title', 'The Royale Palace — Sabores Auténticos de El Salvador'); ?></title>
...
<body>
    ...
    <nav class="trp-navbar" id="trpNavbar">
        <!-- Logo Section -->
        <a href="<?php echo e(route('home')); ?>" class="trp-logo-section">
            <img src="<?php echo e(asset('images/logo.png')); ?>" alt="The Royale Palace" class="trp-logo-img">
            <span class="trp-logo">The <span>Royale</span> Palace</span>
        </a>

        <!-- Center Navigation -->
        <ul class="trp-nav-links d-none d-lg-flex">
            <li><a href="<?php echo e(route('home')); ?>" class="<?php echo e(request()->routeIs('home') ? 'active' : ''); ?>">Inicio</a></li>
            <li><a href="<?php echo e(route('menu.index')); ?>" class="<?php echo e(request()->routeIs('menu.*') ? 'active' : ''); ?>">Menú</a>
            </li>
            <li><a href="<?php echo e(route('reservaciones.create')); ?>"
                    class="<?php echo e(request()->routeIs('reservaciones.*') ? 'active' : ''); ?>">Reservaciones</a></li>
            ...
            <li class="nav-dropdown" id="sedesDropdown">
                ...
                <div class="nav-dropdown-menu">
                    <a href="<?php echo e(route('menu.sede', 'san-salvador')); ?>">
                        <i class="bi bi-geo-alt-fill"></i>San Salvador
                    </a>
                    <a href="<?php echo e(route('menu.sede', 'santa-ana')); ?>">
                        <i class="bi bi-geo-alt-fill"></i>Santa Ana
                    </a>
                    <a href="<?php echo e(route('menu.sede', 'san-miguel')); ?>">
                        <i class="bi bi-geo-alt-fill"></i>San Miguel
                    </a>
                </div>
            </li>

            <li><a href="<?php echo e(route('nosotros')); ?>"
                    class="<?php echo e(request()->routeIs('nosotros') ? 'active' : ''); ?>">Nosotros</a></li>
            <li><a href="<?php echo e(route('contacto')); ?>"
                    class="<?php echo e(request()->routeIs('contacto') ? 'active' : ''); ?>">Contacto</a></li>
        </ul>
        ...
        <div class="trp-nav-right d-none d-lg-flex">
            <?php if(auth()->guard()->check()): ?>
                <div class="auth-section">
                    <a href="<?php echo e(route('cuenta.index')); ?>" title="Mi Cuenta">
                        <i class="bi bi-person-circle"></i>Mi Cuenta
                    </a>
                    <?php if(Auth::user()->hasAnyRole(['super_admin', 'admin_san_salvador', 'admin_santa_ana', 'admin_san_miguel'])): ?>
                        <a href="<?php echo e(route('admin.dashboard')); ?>" title="Panel Admin">
            ...
            <a href="<?php echo e(route('reservaciones.create')); ?>" class="btn-reservar-nav">
    ...
    <div class="mobile-menu" id="mobileMenu">
        <div class="mobile-menu-item">
            <a href="<?php echo e(route('home')); ?>" onclick="closeMobileMenu()">
                <i class="bi bi-house-fill"></i> Inicio
            </a>
        </div>

        <div class="mobile-menu-item">
            <a href="<?php echo e(route('menu.index')); ?>" onclick="closeMobileMenu()">
                <i class="bi bi-book-half"></i> Menú
            </a>
        </div>

        <div class="mobile-menu-item">
            <a href="<?php echo e(route('reservaciones.create')); ?>" onclick="closeMobileMenu()">
        ...
        <div class="mobile-menu-item">
            ...
            <div class="mobile-submenu" id="sedesSubmenu">
                <a href="<?php echo e(route('menu.sede', 'san-salvador')); ?>" onclick="closeMobileMenu()">San Salvador</a>
                <a href="<?php echo e(route('menu.sede', 'santa-ana')); ?>" onclick="closeMobileMenu()">Santa Ana</a>
                <a href="<?php echo e(route('menu.sede', 'san-miguel')); ?>" onclick="closeMobileMenu()">San Miguel</a>
            </div>
        </div>

        <div class="mobile-menu-item">
            <a href="<?php echo e(route('nosotros')); ?>" onclick="closeMobileMenu()">
                <i class="bi bi-people-fill"></i> Nosotros
            </a>
        </div>

        <div class="mobile-menu-item">
            <a href="<?php echo e(route('contacto')); ?>" onclick="closeMobileMenu()">
        ...
        <div class="mobile-menu-footer">
            <?php if(auth()->guard()->check()): ?>
                <a href="<?php echo e(route('cuenta.index')); ?>" onclick="closeMobileMenu()"
                    style="background: var(--color-bg-soft); color: var(--color-dark);">
                    <i class="bi bi-person-circle"></i> Mi Cuenta
                </a>
                <?php if(Auth::user()->hasAnyRole(['super_admin', 'admin_san_salvador', 'admin_santa_ana', 'admin_san_miguel'])): ?>
                    <a href="<?php echo e(route('admin.dashboard')); ?>" onclick="closeMobileMenu()"
                        style="background: var(--color-bg-soft); color: var(--color-dark);">
            ...
            <?php else: ?>
                <a href="<?php echo e(route('login')); ?>" onclick="closeMobileMenu()" class="btn-login">
                    <i class="bi bi-box-arrow-in-right"></i> Iniciar Sesión
                </a>
            <?php endif; ?>
            <a href="<?php echo e(route('reservaciones.create')); ?>" onclick="closeMobileMenu()" class="btn-reservar">
        ...
        <div class="container">
            ...
            <div class="footer-header">
                <div class="footer-brand-group">
                    <img src="<?php echo e(asset('images/logo-b.png')); ?>" alt="The Royale Palace" class="footer-logo-img">
            ...
            <div class="footer-grid">
                ...
                <div class="footer-col">
                    ...
                    <a href="<?php echo e(route('menu.index')); ?>">Menú</a>
                    <a href="<?php echo e(route('reservaciones.create')); ?>">Reservaciones</a>
                    <a href="<?php echo e(route('sucursales')); ?>">Sucursales</a>
                ...
                <div class="footer-col">
                    ...
                    <a href="<?php echo e(route('menu.sede', 'san-salvador')); ?>">San Salvador</a>
                    <a href="<?php echo e(route('menu.sede', 'santa-ana')); ?>">Santa Ana</a>
                    <a href="<?php echo e(route('menu.sede', 'san-miguel')); ?>">San Miguel</a>
                </div>
            ...
            <div class="footer-bottom-line">
                <span class="footer-copy">© <?php echo e(date('Y')); ?> The Royale Palace. Todos los derechos reservados.</span>
...
</html><?php /**PATH C:\xampp\htdocs\royale-palace\resources\views/layouts/app.blade.php ENDPATH**/ ?>
...
<?php $__env->startSection('title', 'Menú ' . $sede->nombre . ' — The Royale Palace'); ?>
        ...
        <div class="container">
            <div class="sede-menu-hero-content">
                <p class="section-label">
                    <i class="bi bi-geo-alt-fill"></i>Zona <?php echo e($sede->zona); ?>

                </p>
                <h1 class="section-title"><?php echo e(strtoupper($sede->nombre)); ?></h1>
        ...
        <div class="container" style="position: relative; z-index: 1;">
            ...
            <div class="menu-tabs-wrapper" id="menuTabs">
                ...
                <?php $__currentLoopData = $categorias; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $cat): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <?php if(isset($platos[$cat->nombre]) && count($platos[$cat->nombre]) > 0): ?>
                        <a href="#<?php echo e(Str::slug($cat->nombre)); ?>" class="menu-tab"
                            onclick="scrollToSection('<?php echo e(Str::slug($cat->nombre)); ?>')">
                            <i class="bi <?php echo e($categoryIcons[$cat->nombre] ?? 'bi-dish'); ?>"></i><?php echo e($cat->nombre); ?>
            ...
            <div id="todos">
                <?php $__empty_1 = true; $__currentLoopData = $platos; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $categoria => $items): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    <div id="<?php echo e(Str::slug($categoria)); ?>" class="categoria-section"
                        style="animation-delay: <?php echo e($loop->index * 0.1); ?>s;">
                        <div class="categoria-header">
                            <div class="categoria-icon">
                                <i class="bi <?php echo e($categoryIcons[$categoria] ?? 'bi-dish'); ?>"></i>
                            </div>
                            <h2 class="categoria-title"><?php echo e($categoria); ?></h2>
                            <span class="categoria-count"><?php echo e(count($items)); ?> platos</span>
                        </div>

                        <div class="row g-4">
                            <?php $__currentLoopData = $items; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $plato): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <div class="col">
                                    <div class="plato-card-menu">
                                        ...
                                        <div class="plato-imagen-container <?php echo e(!$plato->imagen ? 'placeholder' : ''); ?>">
                                            <?php if($plato->imagen): ?>
                                                <img src="<?php echo e(asset('images/platos/' . $plato->imagen)); ?>" alt="<?php echo e($plato->nombre); ?>"
                                        ...
                                        <h3 class="plato-nombre"><?php echo e($plato->nombre); ?></h3>
                                        <p class="plato-descripcion"><?php echo e(Str::limit($plato->descripcion, 100)); ?></p>

                                        
                                        <div class="plato-footer">
                                            <span class="plato-precio">
                                                <span class="plato-precio-signo">$</span><?php echo e(number_format($plato->precio, 2)); ?>

                                            </span>
                                            <?php if(auth()->guard()->check()): ?>
                                                <form method="POST" action="<?php echo e(route('favoritos.toggle', $plato)); ?>"
                                                    style="display: inline;">
                                                    <?php echo csrf_field(); ?>
                                                    <button type="submit"
                                                        class="favorito-btn <?php echo e(auth()->user()->favoritos()->where('plato_id', $plato->id)->exists() ? 'active' : ''); ?>"
                                                        title="<?php echo e(auth()->user()->favoritos()->where('plato_id', $plato->id)->exists() ? 'Quitar de favoritos' : 'Agregar a favoritos'); ?>">
                                                        <i
                                                            class="bi <?php echo e(auth()->user()->favoritos()->where('plato_id', $plato->id)->exists() ? 'bi-heart-fill' : 'bi-heart'); ?>"></i>
                                                    </button>
                                                </form>
                                            <?php else: ?>
                                                <a href="<?php echo e(route('login')); ?>" class="favorito-btn"
        ...
        <div class="container" style="position: relative; z-index: 1;">
            <div style="opacity: 0; animation: fadeInUp 0.6s ease forwards;">
                ...
                <p
                    ...
                    Reserva tu mesa en <?php echo e($sede->nombre); ?> y vive una experiencia gastronómica única.
                </p>
                <div class="d-flex gap-3 justify-content-center flex-wrap">
                    <a href="<?php echo e(route('reservaciones.create', ['sede' => $sede->slug])); ?>" class="btn-gold"
                        style="display: inline-flex; align-items: center; gap: 8px; padding: 12px 28px;">
                        <i class="bi bi-calendar-check"></i> Reservar Mesa
                    </a>
                    <a href="<?php echo e(route('menu.index')); ?>" style="display: inline-flex; align-items: center; gap: 8px; padding: 12px 28px; 
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\royale-palace\resources\views/menu/sede.blade.php ENDPATH**/ ?>